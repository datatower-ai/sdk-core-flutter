...
- (void)reportShowId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)reportShowFailedId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq errorCode:(NSInteger)errorCode errorMessage:(NSString *)errorMessage properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)reportCloseId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)reportClickId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)reportPaidId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq value:(double)value currency:(NSString *)currency precision:(NSString *)precision properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)reportPaidWithCountryId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId value:(double)value precision:(NSString *)precision country:(NSString *)country properties:(NSDictionary<NSString *, id> *)properties error:(FlutterError *_Nullable *_Nonnull)error;
- (void)reportLeftAppId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpDTDTAdPigeon(id<FlutterBinaryMessenger> binaryMessenger, NSObject<DTDTAdPigeon> *_Nullable api);

extern void SetUpDTDTAdPigeonWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<DTDTAdPigeon> *_Nullable api, NSString *messageChannelSuffix);
